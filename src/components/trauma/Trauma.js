...
<div>
        <div id="allgemeines" className="chapters">
          ...
          <div className="content-block"><p>Die Ursachen für Frakturen im Gesichtsschädelbereich sind in der Regel:</p>
            ...
            <div className="startGallery imageContainer" data-gallery-item={1}><img src="thumbs/allgemeines_images.png" />
            </div>
          ...
          <div className="links">
            <div data-media-id={1} data-media-type="image">
              <div className="data-media-thumbnail"><img src="thumbs/1.png" /></div>
        ...
        <div id="weichteilverletzungen" className="chapters">
          ...
          <div className="content-block"><p><span style={{textDecoration: 'underline'}}>Allgemeines</span></p>
            ...
            <div className="startGallery imageContainer" data-gallery-item={1}><img src="thumbs/weichteileverletzungen_images.png" /></div>
            <div className="startGallery imageContainer" data-gallery-item={1}>&nbsp;</div>
        ...
        <div id="luxationDesKiefergelenks" className="chapters">
          ...
          <div className="content-block"><p>Die häufigste Form der Kieferluxation ist <strong>nach ventral</strong>. Sie kann ein-
            ...
            <div className="startGallery imageContainer" data-gallery-item={1}><img src="thumbs/6.png" /></div>
          </div>
          <div className="links">
            <div data-media-id={1} data-media-type="image">
              <div className="data-media-thumbnail"><img src="thumbs/1.png" /></div>
        ...
        <div id="dentaleFrakturen" className="chapters">
          ...
          <div className="content-block"><p>Dentale Frakturen werden anatomisch-topographisch in intra- und extraalveoläre
            ...
            <div className="startGallery imageContainer" data-gallery-item={1}><img src="thumbs/13.png" /></div>
          </div>
          <div className="links">
            <div data-media-id={1} data-media-type="image">
              <div className="data-media-thumbnail"><img src="thumbs/1.png" /></div>
        ...
        <div id="alveolarfortsatzfrakturen" className="chapters">
          ...
          <div className="content-block"><p>Eine Alveolarfortsatzfraktur ist eine umschriebene Aussprenung zumeist zahntragender
            ...
            <div className="startGallery imageContainer" data-gallery-item={1}><img src="thumbs/alveolarfortsatzfrakturen_images.png" /></div>
          </div>
          <div className="links">
            <div data-media-id={1} data-media-type="image">
              <div className="data-media-thumbnail"><img src="thumbs/1.png" /></div>
        ...
        <div id="unterkieferfrakturen" className="chapters">
          ...
          <div className="content-block"><p><span style={{textDecoration: 'underline'}}>Epidemiologie</span></p>
            ...
            <div className="startGallery imageContainer" data-gallery-item={1}><img src="thumbs/unterkieferfrakturen_images.png" /></div>
            <p>&nbsp;</p>
            ...
            <div className="startGallery" data-gallery-item={5}><img className="galleryPoster" src="thumbs/video5.png" />
        ...
        <div id="mittelgesichtsfrakturen" className="chapters">
          ...
          <div className="content-block"><p><span style={{textDecoration: 'underline'}}>Allgemeines</span></p>
            ...
            <div className="startGallery imageContainer" data-gallery-item={4}><img src="thumbs/mittelgesichtsfrakturen_1_images.png" /></div>
            <ul>
              <li>Le-Fort-II
                <ul>
            ...
            <div className="startGallery imageContainer" data-gallery-item={7}><img src="thumbs/mittelgesichtsfrakturen_2_images.png" /></div>
            <ul>
              <li>Le-Fort-III
                <ul>
            ...
            <div className="startGallery imageContainer" data-gallery-item={10}><img src="thumbs/mittelgesichtsfrakturen_3_images.png" /></div>
            <ul>
            ...
            <div className="startGallery" data-gallery-item={13}><img className="galleryPoster" src="thumbs/video6.png" />
              <p className="gallerieThumbDescription">Jochbeinfraktur</p>
              <img className="galleryPoster" src="thumbs/Play_experimentell.png" /></div>
            <span className="startGallery" data-gallery-item={2}><img src="thumbs/mittelgesichtsfrakturen_4_images.png" /></span>
            ...
            <div className="startGallery imageContainer" data-gallery-item={1}><img src="thumbs/mittelgesichtsfrakturen_5_images.png" /></div>
          </div>
          <div className="links">
            <div data-media-id={1} data-media-type="image">
              <div className="data-media-thumbnail"><img src="thumbs/1.png" /></div>
            ...
            <div data-media-id={5} data-media-type="image">
              <div className="data-media-thumbnail"><img src="thumbs/1.png" /></div>
              <img src="images/lefort1%2Cb.png" />
              <div className="media-link-title">LeFort I</div>
        ...
        <div id="nasoorbitoethmoidaleFrakturen" className="chapters">
          ...
          <div className="content-block"><p>Nasoorbitoethmoidale Frakturen sind Brüche des interorbitalen Knochengerüsts. Das
            ...
            <div className="startGallery imageContainer" data-gallery-item={1}><img src="thumbs/18.png" /></div>
          </div>
          <div className="links">
            <div data-media-id={1} data-media-type="image">
              <div className="data-media-thumbnail"><img src="thumbs/1.png" /></div>
        ...
        <div id="panfazialeFrakturen" className="chapters">
          ...
          <div className="content-block"><p>Panfaziale Frakturen werden definiert als ein Frakturgeschehen, welches mindestens 2
            ...
            <div className="startGallery imageContainer" data-gallery-item={1}><img src="thumbs/panfaziale_frakturen_images.png" /></div>
          </div>
          <div className="links">
            <div data-media-id={1} data-media-type="image">
              <div className="data-media-thumbnail"><img src="thumbs/1.png" /></div>
              <img src="images/panfazial.png" />
        ...
        <div id="praevention" className="chapters">
          ...
          <div className="content-block"><p>Gesichtsprotektionsmasken kommen vor allem bei Hochleistungssportlern zum Einsatz, da
            ...
            <div className="startGallery imageContainer" data-gallery-item={1}><img src="thumbs/gesichtsprotektion.png" /></div>
          </div>
          <div className="links">
            <div data-media-id={1} data-media-type="image">
              <div className="data-media-thumbnail"><img src="thumbs/1.png" /></div>
              <img src="images/gesichtsprotektion.png" />
